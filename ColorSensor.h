...
float detectWhite(int taosOutPin){
  return colorRead(taosOutPin,0,1);
}

float detectRed(int taosOutPin){
  return colorRead(taosOutPin,1,1);
}

float detectBlue(int taosOutPin){
  return colorRead(taosOutPin,2,1);
}

float detectGreen(int taosOutPin){
  return colorRead(taosOutPin,3,1);
}
